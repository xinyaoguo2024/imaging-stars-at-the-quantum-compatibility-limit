...
MODE_FALSE_POSITIVE = float(os.environ.get("MODE_FALSE_POSITIVE", "0.02"))
PAIR_FALSE_POSITIVE = float(os.environ.get("PAIR_FALSE_POSITIVE", "0.01"))
DIRECT_FALSE_POSITIVE = float(os.environ.get("DIRECT_FALSE_POSITIVE", str(PAIR_FALSE_POSITIVE)))
